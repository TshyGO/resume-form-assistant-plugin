...
const dataset = {
  ...
  notices: [
    ...
    {
      logicalId: "notice-cancel-b",
      kind: "interview_cancelled",
      receivedAt: "2026-10-19T06:00:00.000Z",
      subject: "平台工程师面试取消",
      body: "原定面试已取消；请等待后续通知，是否更新进度由用户确认。",
      expectedCandidate: "application-b",
      expectedReplyClass: "other",
      expectedSendMode: "automated",
    ...
    },
    {
      ...
      subject: "岗位链接",
      body: "请查看岗位页面；正文不包含凭据。",
      sourceUrl: "https://jobs.d14.example.test/apply?code=D14_SYNTHETIC_BARE_CODE_DO_NOT_STORE&role=platform",
      hasAtsRule: false,
